function [vert, fac] = voxel_density( pts, vox_sz, color, alpha, edgec, w_line, light_option, vox_mag, c_limits )
...
elseif strcmp(light_option, 'heatmap')
    ...
    CB.Label.String = 'Net total power density per subvolume [W/m^3]'; % Label colorbar
