...
% Import data
cond_table_1 = readmatrix([results_path_1 '/G_w_AB_3.000000e+02K.csv']);  
cond_table_2 = readmatrix([results_path_2 '/G_w_AB_3.000000e+02K.csv']);  
cond_table_3 = readmatrix([results_path_3 '/G_w_AB_3.000000e+02K.csv']);  
cond_table_4 = readmatrix([results_path_4 '/G_w_AB_3.000000e+02K.csv']);  
cond_table_5 = readmatrix([results_path_5 '/G_w_AB_3.000000e+02K.csv']);  
