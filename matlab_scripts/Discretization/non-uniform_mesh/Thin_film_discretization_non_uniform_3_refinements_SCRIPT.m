...
% Thin film #1 coarse
Lx_1_c = 250e-9;         % Length of film #1   -- Previously tested: 200e-9, 400e-9, 800e-9
Ly_1_c = 0.5e-6;           % Width of film #1
Lz_1_c = 500e-9;         % Thickness of film #1 -- Previously tested: 200e-9
...
Lx_1_r = 200e-9;         % Length of film #1   -- Previously tested: 200e-9, 400e-9, 800e-9
...
Lx_1_rr = 50e-9;         % Length of film #1   -- Previously tested: 200e-9, 400e-9, 800e-9
...
mesh_1_rr = 1;            % Number of subvolumes across the dimension given in the input 'cord' -- Previously tested:4, 5
...
origin_2_rr = [Lx_1_c+Lx_1_r+Lx_1_rr+d,0,0];  % Point of back, left, bottom of cube [x,y,z]
...
origin_2_r = [Lx_1_c+Lx_1_r+d+Lx_1_rr+Lx_2_rr,0,0];  % Point of back, left, bottom of cube [x,y,z]
...
origin_2_c = [Lx_1_c+Lx_1_r+d+Lx_2_r+Lx_1_rr+Lx_2_rr,0,0];  % Point of back, left, bottom of cube [x,y,z] -Lz_2_r/mesh_2_r
...
r = [R_1_c;R_1_r;R_1_rr;R_2_rr; R_2_r; R_2_c];

% Total number of subvolumes in both films
N = N_1_c + N_1_r +N_1_rr+N_2_rr+ N_2_r + N_2_c;

N_1 = N_1_c + N_1_r+N_1_rr;

% Bulk object start index
ind_bulk = [1, N_1+1];

% Vector of volume of each subvolume [m^3]
delta_V_vector = [delta_V_1_c,delta_V_1_r,delta_V_1_rr,delta_V_2_rr delta_V_2_r, delta_V_2_c];
...
[vert, fac] = voxel_image( R_2_rr, L_sub(N_1_c+N_1_r+N_1_rr+1), [], [], [], [], 'on', [], [] ); %L_sub(1) vox_sz - 1 x 3 vector with voxel size - if vox_sz is a scalar, all edges will have the same length
[vert, fac] = voxel_image( R_2_r, L_sub(N_1_c+N_1_r+N_1_rr+N_2_rr+1), [], [], [], [], 'on', [], [] ); %L_sub(1) vox_sz - 1 x 3 vector with voxel size - if vox_sz is a scalar, all edges will have the same length
[vert, fac] = voxel_image( R_2_c, L_sub(N_1_c+N_1_r+N_1_rr+N_2_rr+N_2_r+1), [], [], [], [], 'on', [], [] ); %L_sub(1) vox_sz - 1 x 3 vector with voxel size - if vox_sz is a scalar, all edges will have the same length
