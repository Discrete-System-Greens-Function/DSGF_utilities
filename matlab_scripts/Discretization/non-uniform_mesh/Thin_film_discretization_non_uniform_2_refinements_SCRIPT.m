...
%saveDir = fullfile(back, '../../Discretizations/');
...
% Thin film #1 coarse
Lx_1_c = 375e-9;%800e-9;         % Length of film #1   -- Previously tested: 200e-9, 400e-9, 800e-9
...
mesh_1_c = 3;            % Number of subvolumes across the dimension given in the input 'cord' -- Previously tested:4, 5

% Thin film #1 refinement #1
Lx_1_r = 125e-9;%200e-9;         % Length of film #1   -- Previously tested: 200e-9, 400e-9, 800e-9
