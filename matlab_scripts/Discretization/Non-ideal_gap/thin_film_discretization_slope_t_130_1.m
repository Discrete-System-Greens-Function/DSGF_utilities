function [ R, delta_V, N_disc ] = thin_film_discretization_slope_1_t_130( L, origin, mesh, cord )
...
R_back(n,3) = z; % Populate location matrix
n=n+1;
x = x1(1)- delta_L/2 -delta_x/3; % Location of discretized volume centers along x direction
y = y1(j)+ delta_L/2; % Location of discretized volume centers along y direction
...
R_back(n,3) = z; % Populate location matrix
n=n+1;
x = x1(1)- delta_L/2 -2*delta_x/3; % Location of discretized volume centers along x direction
y = y1(j)+ delta_L/2; % Location of discretized volume centers along y direction
...
R_back(n,3) = z; % Populate location matrix
n=n+1;
x = x1(1)- 3*delta_L/2 -delta_x/3; % Location of discretized volume centers along x direction
y = y1(j)+ delta_L/2; % Location of discretized volume centers along y direction
z = z1(2)+ delta_L/2; % Location of discretized volume centers along z direction
R_back(n,1) = x; % Populate location matrix
R_back(n,2) = y; % Populate location matrix
